...
export default function Philosophy({ content }: PhilosophyProps) {
  ...
  return (
    <section className="container-full flex flex-col justify-center items-center py-15 gap-6">
      <div className="flex flex-col justify-center items-center gap-2 text-center">
        <p className="paragraph-x-large tracking-[-0.5px] uppercase">
          {content.tag}
        </p>
        <h2 className="title-h2">{content.title}</h2>
        <p className="w-[46%] paragraph font-normal tracking-[-0.5px]">
          {content.description}
        </p>
      </div>
      <div className="grid grid-cols-4 gap-6 justify-center items-stretch w-full">
