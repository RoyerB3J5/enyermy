...
export default function Button({
  ...
  const baseClasses = `cursor-pointer flex justify-center items-center ${paddingX} py-4 rounded-full focus:outline-none transition-all duration-300 ease-in-out text-[14px] font-medium leading-[150%] uppercase tracking-[3px] text-center tokens-clase z-1 w-full ${wFull ? "w-full" : "md:w-auto"}`;
  const styleClasses =
    styleButton === "white"
